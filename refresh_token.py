#!/usr/bin/env python3
"""Art's Golf Cars — refresh del long-lived Instagram access token (~60 días).
Endpoint: GET https://graph.instagram.com/refresh_access_token
  ?grant_type=ig_refresh_token&access_token=<TOKEN>
Guarda el nuevo token en Keychain sobrescribiendo AGOLFCARS_IG_ACCESS_TOKEN.
...
def main():
    tok = secret("AGOLFCARS_IG_ACCESS_TOKEN")
    ...
    if new:
        set_secret("AGOLFCARS_IG_ACCESS_TOKEN", new)
